package com.upc.appcafe.security.config;

import com.upc.appcafe.security.filters.JwtRequestFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/consumidor").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/propietariocafeteria").permitAll()
