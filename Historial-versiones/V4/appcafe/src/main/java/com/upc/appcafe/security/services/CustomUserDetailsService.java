package com.upc.appcafe.security.services;

import com.upc.appcafe.security.entities.User;
import com.upc.appcafe.security.repositories.UserRepository;
 ...
 * Convierte sus roles en GrantedAuthowrity.
...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    public Long obtenerIdUser(String username) throws UsernameNotFoundException {
        User user = userRepository.findByUsername(username)
                .orElseThrow(() -> new UsernameNotFoundException("User not found"));
        return user.getId();
    }
