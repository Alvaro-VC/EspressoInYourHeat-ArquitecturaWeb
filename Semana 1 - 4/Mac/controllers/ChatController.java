...
public class ChatController {
    ...
    @GetMapping("/chats/propio/{id}")
    public ResponseEntity<List<ChatDTO>> encontrarChatsPorIdConsumidor(@PathVariable Long id) {
        List<ChatDTO> lista = iChatService.encontrarChatsPorIdConsumidor(id);
        return  ResponseEntity.ok(lista);
    }
}
